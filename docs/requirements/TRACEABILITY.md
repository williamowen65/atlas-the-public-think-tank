...
| [TAG-010](REQUIREMENTS.md#tag-010) | Node-tag lifecycle preserves audit history | Must | **Partial** | [NodeTag.cs](../../src/Atlas.Graph/Tags/NodeTag.cs)<br>[JsonNodeTagRepository.cs](../../src/Atlas.Console/Storage/JsonNodeTagRepository.cs) | [ReusableTagTests.cs](../../tests/Atlas.Graph.Tests/ReusableTagTests.cs) |
