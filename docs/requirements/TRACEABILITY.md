...
| [VOT-001](REQUIREMENTS.md#vot-001) | Node views report vote totals and averages | Must | **Partial** | [NodeRating.cs](../../src/Atlas.Voting/Model/Votes/VoteValue/NodeRating.cs), [NodeCommands.cs](../../src/Atlas.Console/NodeCommands.cs), [NodeDisplay.cs](../../src/Atlas.Console/NodeDisplay.cs), [NodeVoteSummary.cs](../../src/Atlas.Console/NodeVoteSummary.cs) | [VotingTests.cs](../../tests/Atlas.Voting.Tests/VotingTests.cs); Console workflow manually verified |
| [VOT-002](REQUIREMENTS.md#vot-002) | Voting is the single authority for vote behavior | Must | **Partial** | [Vote.cs](../../src/Atlas.Voting/Model/Vote.cs), [CastVote.cs](../../src/Atlas.Voting/CastVote.cs), [IVoteRepository.cs](../../src/Atlas.Voting/Data/IVoteRepository.cs), [Voting boundary](../architecture/VOTING.md) | [VotingTests.cs](../../tests/Atlas.Voting.Tests/VotingTests.cs) |
...
Automated evidence currently proves valid vote creation, 0–10 rating validation, value immutability, sequential duplicate rejection, and independent votes from different participants. Repository filtering, JSON query/reconstitution behavior, and timestamp preservation still need expanded automated tests.
