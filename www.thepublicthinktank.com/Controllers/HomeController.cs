...
public class HomeController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        if (response.IsSuccessStatusCode)
        {
            ...
            var posts = JsonSerializer.Deserialize<List<Forum_ReadVM>>(jsonString, new JsonSerializerOptions
            {
        ...
        return View(new List<Forum_ReadVM>()); // Return an empty list if the API call fails
    }
