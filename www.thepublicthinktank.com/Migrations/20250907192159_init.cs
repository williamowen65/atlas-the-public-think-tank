    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("06873890-b60a-48c2-bab4-cb7731ec5e01"), "[]", "[4,2,0]", "[1,0]", "[6]", "[2,3]" },
                    { new Guid("1032b6b2-f0f4-437c-9bb8-b386016bbdc7"), "[]", "[2,0,4]", "[1,0]", "[6,3]", "[2,3]" },
                    { new Guid("10873349-5aaa-4e6f-a08a-cbbe1ac2127f"), "[]", "[1,5]", "[2,1]", "[3,5]", "[2]" },
                    { new Guid("1c93c95b-7842-440d-aeb9-cdbd61e1fb2f"), "[]", "[4,1]", "[2,1]", "[6,5]", "[2]" },
                    { new Guid("26524034-13d3-4e9c-a361-ddf01271a71f"), "[]", "[2,4]", "[0,1]", "[6]", "[3]" },
                    { new Guid("2ed7e15a-569a-4d5f-b157-96c8052e3d46"), "[]", "[4,5]", "[1,0]", "[6]", "[2]" },
                    { new Guid("3119d678-b8b9-4c6f-90f7-e35e5d446dfc"), "[]", "[4,0]", "[1,2]", "[6]", "[2]" },
                    { new Guid("38283341-1f14-4b8d-ab4c-f960037ea327"), "[]", "[5,6]", "[1,0,2]", "[3,5]", "[2,3]" },
                    { new Guid("3d3a2d73-23e5-4622-9a82-46d0e6d84d26"), "[]", "[5,4]", "[0,1]", "[6]", "[3]" },
                    { new Guid("56c24d9d-a605-4ed5-991e-cac7944cd747"), "[]", "[0,2]", "[1]", "[6]", "[3]" },
                    { new Guid("681601f2-ed2c-4188-9221-879efa33cc67"), "[]", "[4]", "[1]", "[6]", "[2]" },
                    { new Guid("6efde1fc-a07a-4fc8-b548-aa5a77143efe"), "[]", "[3,1,5]", "[2,1]", "[6,4]", "[2]" },
                    { new Guid("7308cac5-991e-416d-8e59-d567fe29717c"), "[]", "[0,4,1]", "[3,2,1]", "[6]", "[2]" },
                    { new Guid("76bfbcac-97fb-4ee0-b128-d0089e53149c"), "[]", "[4,2]", "[0,1]", "[6]", "[3]" },
                    { new Guid("77f65326-607d-4c65-bff1-424bae316eab"), "[]", "[1,5]", "[1,0]", "[6]", "[3]" },
                    { new Guid("7b9fd298-f051-4664-a274-b642a520ac64"), "[]", "[3,5]", "[2,1]", "[6,4]", "[2]" },
                    { new Guid("81b1b7fc-c732-4c6b-a888-db7ecb9d5609"), "[]", "[4,5]", "[0]", "[1,6]", "[3]" },
                    { new Guid("882d34c7-1a8f-4ca6-afd2-995cae21b60d"), "[]", "[4,2,6]", "[1,0]", "[6]", "[2,3]" },
                    { new Guid("8a86e236-5a53-4801-8b39-f3a3a3ca373e"), "[]", "[3,2]", "[2,1]", "[4,3]", "[2]" },
                    { new Guid("96bb172c-23fc-4359-b324-e221db3682a9"), "[2,1]", "[3]", "[1,2,0]", "[3]", "[0,1]" },
                    { new Guid("a059b123-f631-4774-a866-33ba0bb415b5"), "[]", "[1,5]", "[2,3,1]", "[6]", "[3,2]" },
                    { new Guid("a28b1e20-0234-4d48-91de-0e9b2bf2bc29"), "[]", "[3,1,5]", "[2,1,0]", "[6,5,3]", "[2]" },
                    { new Guid("adb98c92-49b8-47bb-b652-e4917e055150"), "[]", "[2,4]", "[0,1]", "[6]", "[3]" },
                    { new Guid("af37ce9d-db74-43f1-964f-f6fcb394ec9e"), "[]", "[4,0]", "[1,0]", "[6]", "[2]" },
                    { new Guid("b1454543-b9ec-4bb9-9109-edc6a88bb065"), "[]", "[4,1]", "[1,3]", "[6]", "[2]" },
                    { new Guid("b2e2e2c7-7e2a-4e2d-9b1a-2c3e4f5a6b7c"), "[1,2]", "[1,0,2,4,5]", "[0,1,2]", "[3,4,5]", "[1]" },
                    { new Guid("b6e3886d-91ac-412f-82fc-92113cf6b1cc"), "[]", "[5,1,6]", "[2,1,0]", "[5,3]", "[2]" },
                    { new Guid("bf2d669f-8a15-4ea9-8a1e-9e3287addb4f"), "[]", "[2,5]", "[1,2]", "[6]", "[2]" },
                    { new Guid("c0a4e8ff-17dc-43a4-bb13-5931f3a6b687"), "[]", "[1,5,6]", "[2,1,0]", "[5,3]", "[2,3]" },
                    { new Guid("c28f380c-fa61-4113-a38f-d16a4ff4f5f1"), "[]", "[0,2]", "[2,1]", "[6]", "[3,2]" },
                    { new Guid("c52dbb0d-13a4-4702-a829-df6b11b87088"), "[]", "[4,2]", "[1,0]", "[6,3]", "[2,3]" },
                    { new Guid("c65ca915-45d4-4975-929b-9a79199dc51f"), "[]", "[4,2]", "[1]", "[6]", "[3]" },
                    { new Guid("d3415df0-9ae6-450f-8665-eacd297d2ddc"), "[]", "[5,6,2]", "[1,0,2]", "[5,3]", "[2,3]" },
                    { new Guid("d34e087c-ef33-4dd1-98fd-759440c16961"), "[]", "[1,5,3]", "[2,1]", "[5,3]", "[2]" },
                    { new Guid("dbbc70cf-975c-4bb0-9d60-866a88bed614"), "[]", "[4,2,6]", "[1,0]", "[6,3]", "[2]" },
                    { new Guid("e9f82158-76e9-4071-87d5-4e0d8d9d99a6"), "[]", "[2,5]", "[0,1]", "[3,6]", "[2]" },
                    { new Guid("efc852d8-925b-40be-9925-dc499e8be6ee"), "[]", "[5,2,4]", "[0,1,2]", "[6,5]", "[2,3]" },
                    { new Guid("f030a6b4-5fe0-4c87-ba88-a4bd8339a394"), "[]", "[5,1,6]", "[2,1,0]", "[5,3]", "[2,3]" },
                    { new Guid("f1e29a41-926e-40e3-ace4-f1f22a11de0c"), "[]", "[4,1,2]", "[1,0]", "[6]", "[2]" },
                    { new Guid("f57b23e6-8926-45a2-b988-76c122c4202d"), "[]", "[0,2,4]", "[2,1,0]", "[6,5]", "[2,3]" },
                    { new Guid("f89199d9-3218-4712-8362-5c21e4e741c2"), "[]", "[1,5]", "[2,1]", "[6]", "[3,2]" },
                    { new Guid("fa86f462-e7ed-47b4-8c86-c6cc5bfc02e8"), "[]", "[0,2]", "[0,1]", "[6]", "[3,2]" },
                    { new Guid("ff976803-e30a-45d6-a74d-4bcbb024a513"), "[]", "[4,2,0]", "[1,0]", "[6]", "[2,3]" }
                });
