...
namespace atlas_the_public_think_tank.Data
{
    public static partial class SeedData
    {
        ...
        public static async Task SeedDataWithStoredProcedures(ApplicationDbContext context, UserManager<AppUser> userManager, IConfiguration config)
        {

            Console.WriteLine("Seeding database via stored procedures");
